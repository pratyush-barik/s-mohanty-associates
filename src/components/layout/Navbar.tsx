        ...
        <div className="container mx-auto max-w-[1440px] pl-2 pr-6">
          <div className="flex items-center justify-between h-28">
            <Link href="/" className="flex items-center group">
              <div className="transition-all -ml-6 lg:-ml-8 bg-white/95 rounded-full px-4 py-0 flex items-center shadow-sm border border-neutral-100/50">
                <Image
                  ...
                  priority
                  unoptimized
                  className="h-[56px] sm:h-[64px] w-auto object-contain transition-all duration-300"
                />
              </div>
            </Link>
