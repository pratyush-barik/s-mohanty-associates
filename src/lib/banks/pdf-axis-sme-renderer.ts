/**
 * pdf-axis-sme-renderer.ts — Dedicated PDF renderer and types for Axis Bank (SME).
 *
 * Implements the statutory VALUATION REPORT FORMAT (NON-AGRI) handled under Axis SME:
...
export interface AxisSmeFloorItem {
...
export interface AxisSmeReportFields {
  clientType?: string;
...
export class PDFAxisSmeRenderer extends PDFBankRenderer {
  /**
  ...
  /**
   * Main 10-Page Generator for Axis Bank SME
   */
  async generateAxisSmeReport(
    fields: AxisSmeReportFields,
    images: {
    ...
    const formatActualBUA = (floors: AxisSmeFloorItem[]): string => {
...
export default PDFAxisSmeRenderer;
