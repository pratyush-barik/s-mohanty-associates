...
export default function ReportBuilder({ projectId, projectCode, initialFields, status, userRole = 'REPORT_EMPLOYEE', prefill }: ReportBuilderProps) {
  ...
  const handleGeneratePDF = async () => {
    try {
      ...
      measurer.style.cssText = `position:fixed;left:-9999px;top:0;width:${CONTENT_W}px;font-family:'Times New Roman',serif;color:#000;line-height:1.2em;visibility:hidden;`;
  ...
  function generatePDFBlocks(): string[] {
    ...
    const simpleRow = (label: string, val: string) => {
      return `<tr><td colspan="3" style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;line-height:1.2em;word-break:break-word;word-wrap:break-word;overflow:visible;">${label}: - <b>${val || 'N/A'}</b></td></tr>`;
    };
    ...
    const optionRow = (label: string, opts: string[], val: string) => {
      ...
      return `<tr>
        ...
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;text-align:center;background:${optLblBg};line-height:1.2em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="37%">${val || 'N/A'}</td>
      </tr>`;
    };
    ...
    const ageOptionRow = (label: string, opts: string[], selectedOpt: string, actualVal: string) => {
      ...
      return `<tr>
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;background:${lblBg};line-height:1.2em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="28%">${label}</td>
        <td style="border:${cellBorder};padding:0;font-family:${ff};font-size:12pt;vertical-align:top;background:${optLblBg};" width="35%">${innerDivs}</td>
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;text-align:center;background:${optLblBg};line-height:1.2em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="37%">${actualVal || 'N/A'}</td>
      </tr>`;
    };
    ...
    allBlocks.push(`<div style="font-family:${ff};font-size:12pt;margin-bottom:10px;line-height:1.2em;">
    ...
    // ── BLOCK: Declaration ──
    allBlocks.push(`<div style="margin-top:10px;font-family:${ff};font-size:12pt;line-height:1.2em;">
    ...
    allBlocks.push(`
      ...
      <div style="border:1.5px solid #000;padding:12px;font-family:${ff};font-size:12pt;line-height:1.2em;">
      ...
      <div style="margin-top:28px;text-align:right;font-family:${ff};font-size:12pt;line-height:1.2em;">
