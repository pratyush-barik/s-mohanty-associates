...
export default function ReportBuilder({ projectId, projectCode, initialFields, status, userRole = 'REPORT_EMPLOYEE', prefill }: ReportBuilderProps) {
  ...
  const handleGeneratePDF = async () => {
    try {
      ...
      measurer.style.cssText = `position:fixed;left:-9999px;top:0;width:${CONTENT_W}px;font-family:'Times New Roman',serif;color:#000;line-height:1.0em;visibility:hidden;`;
      ...
      for (let i = 0; i < pages.length; i++) {
        ...
        container.innerHTML = `<div style="line-height:1.0em;">${pages[i].join('')}</div>`;
  ...
  function generatePDFBlocks(): string[] {
    ...
    const simpleRow = (label: string, val: string) => {
      return `<tr><td colspan="3" style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">${label}: - <b>${val || 'N/A'}</b></td></tr>`;
    };
    ...
    const optionRow = (label: string, opts: string[], val: string) => {
      ...
      const innerDivs = opts.map((o, i) =>
        `<div style="border-bottom:${i === n - 1 ? 'none' : '1px solid #000'};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;background:${optLblBg};word-break:break-word;word-wrap:break-word;overflow:visible;">${o}</div>`
      ).join('');
      return `<tr>
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;background:${lblBg};line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="28%">${label}</td>
        ...
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;text-align:center;background:${optLblBg};line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="37%">${val || 'N/A'}</td>
      </tr>`;
    };
    ...
    const ageOptionRow = (label: string, opts: string[], selectedOpt: string, actualVal: string) => {
      ...
      const innerDivs = opts.map((o, i) => {
        ...
        return `<div style="border-bottom:${i === n - 1 ? 'none' : '1px solid #000'};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;background:${optLblBg};word-break:break-word;word-wrap:break-word;overflow:visible;${fontStyle}">${o}</div>`;
      }).join('');
      return `<tr>
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;background:${lblBg};line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="28%">${label}</td>
        <td style="border:${cellBorder};padding:0;font-family:${ff};font-size:12pt;vertical-align:top;background:${optLblBg};" width="35%">${innerDivs}</td>
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;text-align:center;background:${optLblBg};line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="37%">${actualVal || 'N/A'}</td>
      </tr>`;
    };

    // Section header row
    const sectionHeader = (title: string) => {
      return `<tr><td colspan="3" style="border:${cellBorder};padding:4px 8px 4px 8px;font-family:${ff};font-size:14pt;font-weight:bold;background:${lblBg};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">${title}</td></tr>`;
    };
    ...
    allBlocks.push(`<div style="font-family:${ff};font-size:12pt;margin-bottom:10px;line-height:1.0em;">
    ...
    allBlocks.push(wrapTable(`
      ...
      <tr>
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;background:${lblBg};line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="28%">Proximity to Civic Amenities</td>
        <td style="border:${cellBorder};padding:0;font-family:${ff};font-size:12pt;vertical-align:top;background:${optLblBg};" width="35%">
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">Nearest Railway Station</div>
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">Nearest Bus Stop</div>
          <div style="padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">Nearest Hospital</div>
        </td>
        <td style="border:${cellBorder};padding:0;font-family:${ff};font-size:12pt;vertical-align:top;background:${optLblBg};" width="37%">
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">1. ${fields.landmarkRailway || fields.distanceRailwayStation || 'N/A'}</div>
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">2. ${fields.landmarkBusStop || fields.distanceBusStop || 'N/A'}</div>
          <div style="padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">3. ${fields.landmarkHospital || fields.distanceHospital || 'N/A'}</div>
        </td>
      </tr>
      ...
      <tr>
        <td style="border:${cellBorder};padding:${cellPad};font-family:${ff};font-size:12pt;vertical-align:middle;font-weight:bold;background:${lblBg};line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;" width="28%">Landmark Details</td>
        <td style="border:${cellBorder};padding:0;font-family:${ff};font-size:12pt;vertical-align:top;background:${optLblBg};" width="35%">
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">Nearest Railway Station</div>
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">Nearest Bus Stop</div>
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">Nearest Hospital</div>
          <div style="padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">Nearest Landmark</div>
        </td>
        <td style="border:${cellBorder};padding:0;font-family:${ff};font-size:12pt;vertical-align:top;background:${optLblBg};" width="37%">
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">1. ${fields.landmarkRailway || 'N/A'}</div>
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">2. ${fields.landmarkBusStop || 'N/A'}</div>
          <div style="border-bottom:1px solid #000;padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">3. ${fields.landmarkHospital || 'N/A'}</div>
          <div style="padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;line-height:1.0em;box-sizing:border-box;word-break:break-word;word-wrap:break-word;overflow:visible;">4. ${fields.landmarkNearest || fields.landmark || 'N/A'}</div>
        </td>
      </tr>
    `));
    ...
    const floorRowsHTML = floorValuations.map((f, idx) => {
      ...
      return `<tr style="background:${bg};">
        <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">${f.name}</td>
        <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;text-align:right;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">${formatIndianCurrency(f.area)}</td>
        <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;text-align:right;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">\u20B9${formatIndianCurrency(f.rate)}</td>
        <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;text-align:right;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">\u20B9${formatIndianCurrency(f.estimated)}</td>
        <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;text-align:center;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">${f.lifeYears}</td>
        <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;text-align:center;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">${f.ageYears}</td>
        <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;text-align:center;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">${f.depPct}%</td>
        <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;text-align:right;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">\u20B9${formatIndianCurrency(f.netValue)}</td>
      </tr>`;
    }).join('');
    ...
    allBlocks.push(`
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:10px;font-family:${ff};font-size:12pt;">
        <tr style="background:#000;">
          <th style="border:${cellBorder};padding:4px 6px 4px 6px;color:#FFF;font-weight:bold;text-align:center;font-family:${ff};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">Floor</th>
          <th style="border:${cellBorder};padding:4px 6px 4px 6px;color:#FFF;font-weight:bold;text-align:right;font-family:${ff};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">Area</th>
          <th style="border:${cellBorder};padding:4px 6px 4px 6px;color:#FFF;font-weight:bold;text-align:right;font-family:${ff};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">Rate (\u20B9)</th>
          <th style="border:${cellBorder};padding:4px 6px 4px 6px;color:#FFF;font-weight:bold;text-align:right;font-family:${ff};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">Estimated (\u20B9)</th>
          <th style="border:${cellBorder};padding:4px 6px 4px 6px;color:#FFF;font-weight:bold;text-align:center;font-family:${ff};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">Life</th>
          <th style="border:${cellBorder};padding:4px 6px 4px 6px;color:#FFF;font-weight:bold;text-align:center;font-family:${ff};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">Age</th>
          <th style="border:${cellBorder};padding:4px 6px 4px 6px;color:#FFF;font-weight:bold;text-align:center;font-family:${ff};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">Dep%</th>
          <th style="border:${cellBorder};padding:4px 6px 4px 6px;color:#FFF;font-weight:bold;text-align:right;font-family:${ff};vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;">Net Value (\u20B9)</th>
        </tr>
        ${floorRowsHTML}
        <tr style="font-weight:bold;">
          <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;" colspan="7"><b>Total Building Value</b></td>
          <td style="border:${cellBorder};padding:4px 6px 4px 6px;font-family:${ff};font-size:12pt;text-align:right;vertical-align:middle;line-height:1.0em;word-break:break-word;word-wrap:break-word;overflow:visible;"><b>\u20B9${formatIndianCurrency(totalBuildingValue)}</b></td>
        </tr>
      </table>
    `);
    ...
    // ── BLOCK: Declaration ──
    allBlocks.push(`<div style="margin-top:10px;font-family:${ff};font-size:12pt;line-height:1.0em;">
    ...
    allBlocks.push(`
      ...
      <div style="border:1.5px solid #000;padding:12px;font-family:${ff};font-size:12pt;line-height:1.0em;">
      ...
      <div style="margin-top:28px;text-align:right;font-family:${ff};font-size:12pt;line-height:1.0em;">
