...
export const AXIS_SBB_CONFIG: BankConfig = {
  ...
  navSections: [
    { id: 'section-cover', title: 'Header & Bank Details' },
    { id: 'axis-sbb-section-2', title: 'Purpose & Schedule' },
    { id: 'axis-sbb-section-3', title: 'Location & Address' },
    { id: 'axis-sbb-section-4', title: 'Title & Legal Docs' },
    { id: 'axis-sbb-section-5', title: 'Surroundings & Infra' },
    { id: 'axis-sbb-section-6', title: 'Boundaries & Access' },
    { id: 'axis-sbb-section-7', title: 'Structure & Approvals' },
    { id: 'axis-sbb-section-8', title: 'Floor Break Up' },
    { id: 'axis-sbb-section-9', title: 'Valuation Engine' },
    { id: 'axis-sbb-section-10', title: 'Remarks & Undertaking' },
    { id: 'section-documents', title: 'Documents' },
    { id: 'section-12', title: 'Maps' },
    { id: 'section-11', title: 'Property Photographs' },
    { id: 'annexures', title: 'Annexures' },
  ],
  fieldLabels: {
  ...
  extraSectionsStart: [
    ...
    },
    {
      ...
      render: (fields: any, handleChange: any, isReadOnly: boolean) => {
        ...
        return (
          <div className="animate-fade-in space-y-6">
            <div className="border border-[#A7F3D0] bg-[#ECFDF5] rounded-xl p-4 relative shadow-sm">
                    ...
                    <tr className="divide-x divide-[#A7F3D0]">
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className={`w-full text-base p-2 border-gray-300 rounded-md shadow-sm pr-8 focus:border-blue-500 focus:ring-blue-500 ${!fields.axisSbbValuationLandAreaEditOn || isReadOnly ? 'bg-gray-100 cursor-not-allowed disabled:opacity-100' : 'bg-white'}`} value={fields.axisSbbValuationLandAreaIsNA ? '' : (fields.axisSbbValuationLandAreaEditOn ? (fields.axisSbbValuationLandArea || '') : landAreaPrefill)} onChange={e => handleChange('axisSbbValuationLandArea', e.target.value)} disabled={isReadOnly || !!fields.axisSbbValuationLandAreaIsNA || !fields.axisSbbValuationLandAreaEditOn} />
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-gray-100 cursor-not-allowed font-bold disabled:text-gray-500 pr-8" value={fields.axisSbbValuationLandAmountIsNA ? '' : landAmount.toFixed(2)} disabled />
                    ...
                    <tr className="divide-x divide-[#A7F3D0]">
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-gray-100 cursor-not-allowed font-bold disabled:text-gray-500 pr-8" value={fields.axisSbbValuationBuildingAmountIsNA ? '' : buildingAmount.toFixed(2)} disabled />
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 group cursor-help" title="AREA (SQ.FT) * RATE PER SQ.FT (RS.)">
                              <Lock className="w-5 h-5 text-[#065F46] group-hover:text-emerald-900" />
                            </div>
                          </div>
                    ...
                    <tr className="divide-x divide-[#A7F3D0]">
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-gray-100 cursor-not-allowed font-bold disabled:text-gray-500 pr-8" value={fields.axisSbbValuationAmenitiesAmountIsNA ? '' : amenitiesAmount.toFixed(2)} disabled />
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 group cursor-help" title="AREA (SQ.FT) * RATE PER SQ.FT (RS.)">
                              <Lock className="w-5 h-5 text-[#065F46] group-hover:text-emerald-900" />
                            </div>
                          </div>
                    ...
                    <tr className="bg-[#D1FAE5] divide-x divide-[#A7F3D0]">
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-gray-100 cursor-not-allowed font-bold disabled:text-[#065F46] pr-8" value={fields.axisSbbValuationTotalAmountIsNA ? '' : totalAmountComp.toFixed(2)} disabled />
                    ...
                    <tr className="bg-[#D1FAE5] divide-x divide-[#A7F3D0]">
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 rounded-md shadow-sm bg-gray-100 cursor-not-allowed font-bold disabled:text-[#065F46] border-gray-300 pr-8" value={fields.axisSbbValuationTotalSayAmountIsNA ? '' : totalSayComp.toFixed(2)} disabled />
