  ...
  extraSectionsStart: [
    ...
    },
    {
      ...
      render: (fields: any, handleChange: any, isReadOnly: boolean) => {
        ...
        return (
          <div className="animate-fade-in space-y-6">
            <div className="border border-[#A7F3D0] bg-[#D1FAE5] rounded-xl p-4 relative shadow-sm">
              <h3 className="font-bold text-[#065F46] mb-4 uppercase">Market Valuation Calculation</h3>
              <div className="overflow-x-auto">
                <table className="w-full text-sm border-collapse bg-transparent shadow-sm rounded-md overflow-hidden">
                  <thead className="bg-[#D1FAE5] border-b border-[#A7F3D0]">
                    ...
                    <tr>
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className={`w-full text-base p-2 border-gray-300 rounded-md shadow-sm pr-8 focus:border-blue-500 focus:ring-blue-500 ${!fields.axisSbbValuationLandAreaEditOn || isReadOnly ? 'bg-[#ECFDF5] cursor-not-allowed disabled:opacity-100' : 'bg-white'}`} value={fields.axisSbbValuationLandAreaIsNA ? '' : (fields.axisSbbValuationLandAreaEditOn ? (fields.axisSbbValuationLandArea || '') : landAreaPrefill)} onChange={e => handleChange('axisSbbValuationLandArea', e.target.value)} disabled={isReadOnly || !!fields.axisSbbValuationLandAreaIsNA || !fields.axisSbbValuationLandAreaEditOn} />
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-white focus:border-blue-500 focus:ring-blue-500" value={fields.axisSbbValuationLandRateIsNA ? '' : (fields.axisSbbValuationLandRate || '')} onChange={e => handleChange('axisSbbValuationLandRate', e.target.value)} disabled={isReadOnly || !!fields.axisSbbValuationLandRateIsNA} />
                        </div>
                      </td>
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-[#ECFDF5] cursor-not-allowed font-bold disabled:text-gray-500 pr-8" value={fields.axisSbbValuationLandAmountIsNA ? '' : landAmount.toFixed(2)} disabled />
                    ...
                    <tr>
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-white focus:border-blue-500 focus:ring-blue-500" value={fields.axisSbbValuationBuildingRateIsNA ? '' : (fields.axisSbbValuationBuildingRate || '')} onChange={e => handleChange('axisSbbValuationBuildingRate', e.target.value)} disabled={isReadOnly || !!fields.axisSbbValuationBuildingRateIsNA} />
                        </div>
                      </td>
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-[#ECFDF5] cursor-not-allowed font-bold disabled:text-gray-500 pr-8" value={fields.axisSbbValuationBuildingAmountIsNA ? '' : buildingAmount.toFixed(2)} disabled />
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 group cursor-help" title="AREA (SQ.FT) * RATE PER SQ.FT (RS.)">
                              <Lock className="w-5 h-5 text-[#065F46] group-hover:text-emerald-900" />
                            </div>
                          </div>
                    ...
                    <tr>
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-white focus:border-blue-500 focus:ring-blue-500" value={fields.axisSbbValuationAmenitiesAreaIsNA ? '' : (fields.axisSbbValuationAmenitiesArea || '')} onChange={e => handleChange('axisSbbValuationAmenitiesArea', e.target.value)} disabled={isReadOnly || !!fields.axisSbbValuationAmenitiesAreaIsNA} />
                        </div>
                      </td>
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          <div className="flex justify-end">{renderNaToggle('axisSbbValuationAmenitiesRate')}</div>
                          <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-white focus:border-blue-500 focus:ring-blue-500" value={fields.axisSbbValuationAmenitiesRateIsNA ? '' : (fields.axisSbbValuationAmenitiesRate || '')} onChange={e => handleChange('axisSbbValuationAmenitiesRate', e.target.value)} disabled={isReadOnly || !!fields.axisSbbValuationAmenitiesRateIsNA} />
                        </div>
                      </td>
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-[#ECFDF5] cursor-not-allowed font-bold disabled:text-gray-500 pr-8" value={fields.axisSbbValuationAmenitiesAmountIsNA ? '' : amenitiesAmount.toFixed(2)} disabled />
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 group cursor-help" title="AREA (SQ.FT) * RATE PER SQ.FT (RS.)">
                              <Lock className="w-5 h-5 text-[#065F46] group-hover:text-emerald-900" />
                            </div>
                          </div>
                    ...
                    <tr className="bg-transparent">
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 border-gray-300 rounded-md shadow-sm bg-[#ECFDF5] cursor-not-allowed font-bold disabled:text-[#065F46] pr-8" value={fields.axisSbbValuationTotalAmountIsNA ? '' : totalAmountComp.toFixed(2)} disabled />
                    ...
                    <tr className="bg-[#A7F3D0]">
                      ...
                      <td className="p-3 align-top">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-base p-2 rounded-md shadow-sm bg-[#ECFDF5] cursor-not-allowed font-bold disabled:text-[#065F46] border-gray-300 pr-8" value={fields.axisSbbValuationTotalSayAmountIsNA ? '' : totalSayComp.toFixed(2)} disabled />
                    ...
                    <tr>
                      ...
                      <td className="p-3">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-sm border-gray-300 rounded-md shadow-sm bg-[#CEF2D9] cursor-not-allowed pr-8 disabled:opacity-100 font-bold text-gray-600" value={fields.axisSbbGovtLandAmountIsNA ? '' : govtLandAmount.toFixed(2)} disabled />
                    ...
                    <tr>
                      ...
                      <td className="p-3">
                        <div className="flex flex-col gap-1">
                          ...
                          <div className="relative mt-1">
                            <input type="number" step="0.01" className="w-full text-sm border-gray-300 rounded-md shadow-sm bg-[#CEF2D9] cursor-not-allowed pr-8 disabled:opacity-100 font-bold text-gray-600" value={fields.axisSbbGovtBuildingAmountIsNA ? '' : govtBuildingAmount.toFixed(2)} disabled />
                            <div className="absolute inset-y-0 right-0 flex items-center pr-3 group cursor-help" title="AREA (SQ.FT) * GUIDELINE RATE PER SQ.FT (RS.)">
                              <Lock className="w-5 h-5 text-gray-400 group-hover:text-gray-600" />
                            </div>
                          </div>
