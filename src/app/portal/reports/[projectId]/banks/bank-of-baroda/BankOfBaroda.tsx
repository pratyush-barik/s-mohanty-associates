...
export const BANK_OF_BARODA_CONFIG: BankConfig = {
  ...
  defaultValues: {
    ...
    // ── Section 3: Part II — CHARACTERISTICS ──
    bobClassificationOfLocality: '', bobClassificationOfLocalityNA: false,
    bobDevelopmentOfSurrounding: '',
    bobFloodingPossibility: '', bobFloodingPossibilityNA: false,
    bobCivicAmenities: '',
    bobLevelOfLand: '',
    bobShapeOfLand: '',
    bobTypeOfUse: '',
    bobUsageRestriction: '', bobUsageRestrictionNA: false,
    bobTownPlanningApproved: '',
    bobCornerOrIntermittent: '',
    bobRoadFacilities: '',
    bobTypeOfRoad: '',
    bobWidthOfRoad: '',
    bobLandLocked: '',
    bobWaterPotentiality: '',
    bobSewerage: '',
    bobPowerSupply: '',
    bobAdvantageOfSite: '',
    bobSpecialRemarks: '', bobSpecialRemarksNA: false,
    // ── Section 4: Part A — Land Valuation ──
    bobLandSizeNS: '', bobLandSizeEW: '',
    bobLandTotalExtent: '', bobLandTotalExtentEditOn: false,
    bobPrevailingMarketRate: '',
    bobGuidelineRate: '',
    bobAdoptedRate: '',
    bobEstimatedLandValue: '', bobEstimatedLandValueEditOn: false,
    // ── Section 5: Part B — Building Valuation ──
    bobBuildingType: '', bobConstructionType: '',
    bobYearOfConstruction: '', bobFloorsDescription: '',
    bobPlinthArea: '',
    bobConditionExterior: '', bobConditionInterior: '',
    bobApprovedMapDate: '', bobApprovedMapDateNA: false,
    bobApprovedMapAuthority: '', bobApprovedMapAuthorityNA: false,
    bobApprovedMapVerified: '', bobApprovedMapVerifiedNA: false,
    bobApprovedMapComments: '', bobApprovedMapCommentsNA: false,
    bobBuildingAge: '', bobBuildingAgeEditOn: false,
    bobResidualLife: '',
    bobStructuralDetails: {},
    bobOtherFloorsNA: false,
    bobCompoundWall: '',
    bobCompoundWallHeight: '', bobCompoundWallLength: '', bobCompoundWallType: '',
    bobElectricalWiring: '', bobElectricalFittings: '',
    bobElectricalLightPoints: '', bobElectricalFanPoints: '', bobElectricalPlugPoints: '',
    bobPlumbing: '',
    bobWaterClosets: '', bobWashBasins: '', bobUrinals: '', bobBathTubs: '',
    bobWaterMeterTaps: '', bobOtherFixtures: '',
    // ── Section 6: Valuation & Amenities ──
    bobBuildingValuationRows: [],
    bobAmenity_0: '', bobAmenity_1: '', bobAmenity_2: '', bobAmenity_3: '', bobAmenity_4: '',
    bobAmenity_5: '', bobAmenity_6: '', bobAmenity_7: '', bobAmenity_8: '', bobAmenity_9: '',
    bobMisc_0: '', bobMisc_1: '', bobMisc_2: '', bobMisc_3: '',
    bobService_0: '', bobService_1: '', bobService_2: '', bobService_3: '', bobService_4: '',
    // ── Section 7: Total Abstract & Remarks ──
    bobAbstract_land_govt: '', bobAbstract_building_govt: '',
    bobAbstract_extraItems_govt: '', bobAbstract_extraItems_market: '',
    bobAbstract_amenities_govt: '', bobAbstract_miscellaneous_govt: '',
    bobAbstract_services_govt: '',
    bobAbstractTotalGovt: '', bobAbstractTotalGovtEditOn: false,
    bobAbstractTotalMarket: '', bobAbstractTotalMarketEditOn: false,
    bobAbstractTotalRealizable: '', bobAbstractTotalRealizableEditOn: false,
    bobAbstractTotalDistress: '', bobAbstractTotalDistressEditOn: false,
    bobAbstractOrSayGovt: '', bobAbstractOrSayMarket: '',
    bobAbstractOrSayRealizable: '', bobAbstractOrSayDistress: '',
    bobRemarks: '',
    bobSignOffPlace: '',
    // ── Section 8: Questionnaire ──
    bobDeclarationQuestionnaire: [],
    // ── Section 9: Affirmations ──
    bobAffirmationName: '', bobAffirmationFatherName: '',
    bobAffirmationChecks: {},
    bobAffirmationPAN: '',
    bobAffirmationPlace: '',
    // ── Section 10: Code of Conduct ──
    bobCodeOfConductValues: {},
    bobCodeOfConductAcknowledged: false,
    bobCodeOfConductPlace: '',
  } as any,
  extraSectionsStart: [
    /* ──────────────────────────────────────────────────────────────────────
